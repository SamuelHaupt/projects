TITLE Designing Low-Level I/O Procedures     (Proj6_hauptsa.asm)
...
_PotentiallyInvalidInput:
  MOV	BL, negativeSymbol
  CMP	BL, NEGATIVE_SYMBOL
  JNE	_IsNotValidInput
  
  ;simply for boarder case of at −2147483648
  TEST	AL, AL
  MOV	EBX, [EBP + 5*FOUR_BYTES]
  MOV	EAX, [EBX]
  DEC	EAX
  MOV	[EBX], EAX				;SKIPS CLEARING OV FLAG IN NEXT SEGMENT
  TEST	AL, AL
  SUB	EAX, 1
  JO	_IsNotValidInput
  INC	EAX
